<template>
  <div class="agent-top content" v-if="isAgent">
    ...
    <div class="infos">
      <div class="ml15">
        ...
        <div class="texts">
          ...
          <a
            href="javascript:;"
            @click="updateMoney('actived')"
            class="iconay ay-f14 btn003"
    ...
    <div class="infos displayBlock">
      <div class="ml15">
        <div class="texts">
          <span class="text-info">其他佣金：</span>
        </div>
        <div class="texts">
          <span class="money">￥{{userData.liveAccount}}</span>元
          <a
            href="javascript:;"
            @click="updateMoney('actived1')"
            class="iconay ay-f14 btn003"
            :class="{xuanzhuan:actived1==true}"
          ></a>
        </div>
      </div>
      ...
      <div class="texts w100">
        <div class="ml15 mt15">
          ...
          <router-link :to="{name: 'agent_message'}">
            <div class="minibtn msg savebtn">消息
              <div class="nav-counter nav-counter-red">{{unread}}</div>
            </div>
          </router-link>
        </div>
      </div>
