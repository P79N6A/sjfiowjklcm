        ...
        <div class="process-info-wrap" v-show="dialogVisible">
          ...
          <div class="process-info-content">
            <div class="content-info">
              <table
                class="processTable"
                v-loading="transferAllIng"
                element-loading-text="请求正在执行，请稍等..."
              >
                <tbody>
                  <tr>
                  ...
                  <tr
                    v-for="(trData,i) in tableData"
                    :key="i"
                    v-if="trData.balance>=1&&!transferAllIng"
                  >
                    ...
                    <td>
                      <span style="color:#ea5048;">{{trData.remark}}</span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="5">
                      <el-button
                        type="danger"
                        @click="dialogVisible = false;UPDATE_MONEY('MAIN')"
                        v-show="!transferAllIng"
                      >关闭</el-button>
                      <el-button type="danger" @click="toDrawmoney" v-show="!transferAllIng">我要提款</el-button>
                    </td>
                  </tr>
                </tbody>
              </table>
