// require('pc/assets/scss/animation.scss') // 引入全局样式
...
Vue.use(VueLazyload, {
  ...
  adapter:{
    error(listender,Init){
      listender.src = listender.src.replace(/www.staticsources.com/g,"qiniuyunback.staticesources.com")
    }
  }
})
// 注册element组件
