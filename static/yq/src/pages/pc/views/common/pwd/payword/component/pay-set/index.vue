<template>
  <div class="pay-set" v-if="!isSetPayPwd">
    <el-form
      :model="pwdForm"
      status-icon
      :rules="pwdrules"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      pwdrules: {
        password: [{ validator: password_check, trigger: "blur" }],
        new_password: [{ validator: new_password_check, trigger: "blur" }],
        confirm_password: [
