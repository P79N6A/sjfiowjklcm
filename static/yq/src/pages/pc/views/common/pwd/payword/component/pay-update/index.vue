<template>
  <div class="pay-update" v-if="isSetPayPwd">
    <el-form
      :model="pwdForm"
      status-icon
      :rules="pwdrules"
    ...
    >
      <el-form-item label="原支付密码：" prop="password">
        ...
        >
          ...
          ></el-button>
          <el-button slot="append" icon="el-icon-view" @click="showPwd('password')" v-else></el-button>
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="新支付密码：" prop="new_password">
        ...
        >
          <el-button
            slot="append"
            icon="el-icon-remove-outline"
            @click="showPwd('new_password')"
            v-if="passwordType.new_password=='password'"
          ></el-button>
          <el-button slot="append" icon="el-icon-view" @click="showPwd('new_password')" v-else></el-button>
        </el-input>
      </el-form-item>
      <el-form-item label="确认支付密码：" prop="confirm_password">
        ...
        >
          <el-button
            slot="append"
            icon="el-icon-remove-outline"
            @click="showPwd('confirm_password')"
            v-if="passwordType.confirm_password=='password'"
          ></el-button>
          <el-button slot="append" icon="el-icon-view" @click="showPwd('confirm_password')" v-else></el-button>
        </el-input>
      </el-form-item>

      <el-form-item>
        <el-button @click="submitForm('pwdForm')" type="primary">提交</el-button>
        <!-- <el-button @click="resetForm('pwdForm')">清空</el-button> -->
        <el-button @click="$bus.$emit('showForgetPay',true)" type="text">重置支付密码?</el-button>
      </el-form-item>
    </el-form>
    <!-- 找回支付密码(有待完善) -->
