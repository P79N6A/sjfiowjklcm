        ...
        <transition name="slideLeft">
          <div v-show="myValue" class="tool-bar">
            ...
            <div @click="myValue=false">
              ...
              <router-link class="tool-item-href" :to="{name:'guideMenu'}">
              ...
              <router-link class="tool-item-href" :to="{name:'serviceList'}" v-if="islogin">
...
.tool-warp {
  ...
  .tool-bar {
    ...
    height: 100%;
    width: 80%;
    background: url("./images/comm-bg.png") no-repeat top/100%;
    // padding-top:r(20);
    overflow-y: scroll;
    &.active {
      display: block;
