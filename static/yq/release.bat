...
:: rsync 指向
set rsync_target=leo@54.179.138.61::qhcstatic
set rsync_target_test=leo@172.16.27.200::zystatic
set rsync_target_demo=leo@54.179.138.61::demostatic
...
:demo
echo ====demo====
rsync -auvz --progress --delete  --password-file=/cygdrive/c/rsyncd.secrets<c:/pwd.txt %source_dir%  %rsync_target_demo%  --exclude=*svn* --exclude=*properties*  --exclude=*.jar --exclude=*.jsp --exclude=*.class --exclude=*classes* --exclude=/WEB-INF --exclude=/payment --exclude=/META-INF --exclude=/commons --exclude=/tpl
goto end
