...
// const $allGamesDataPc = '/static/slot/allGames.json' // 获取游戏大厅列表pc
// const $allGamesDataMobile = '/static/slot/allPhoneGames.json' // 获取游戏大厅列表mobile
// const $mwqpGamesData = '/static/slot/mwqp.json' // 获取棋牌游戏大厅列表
const $allGamesDataPc = 'https://www.staticsources.com/slot/abyh/allGames.json' // 获取游戏大厅列表pc abyh
const $allGamesDataMobile = 'https://www.staticsources.com/slot/abyh/allPhoneGames.json' // 获取游戏大厅列表mobile
...
export function checkConfigSystem(data) {
  return ajax.post($checkConfigSystem)
}
