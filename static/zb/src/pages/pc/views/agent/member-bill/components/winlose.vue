  ...
  <div class="agent-deposit-log">
    <div class="winlose-info">
      ...
      <el-table :data="pageContents" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="会员账号" prop="loginname"></el-table-column>
        <el-table-column label="平台" prop="platform"></el-table-column>
        <el-table-column label="投注总额" prop="bettotal"></el-table-column>
        <el-table-column label="输赢值" prop="amount"></el-table-column>
