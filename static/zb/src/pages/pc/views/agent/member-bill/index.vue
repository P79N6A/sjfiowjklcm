      ...
      getAgentQueryType().then(res => {
        if (res.success) {
          for (let i = 0; i < res.data.length; i++) {
            ...
            console.log(this.Menus[res.data[i].value])
    ...
    .u-c-menu {
      ...
      .u-c-router {
        ...
        &.active {
          ...
          background: #0181fa;
          /* Old browsers */
          background: -moz-linear-gradient(left, #0181fa 0%, #16d6ff 100%);
          /* FF3.6-15 */
          background: -webkit-linear-gradient(left, #0181fa 0%, #16d6ff 100%);
          /* Chrome10-25,Safari5.1-6 */
          background: linear-gradient(to right, #0181fa 0%, #16d6ff 100%);
          /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
          filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0181fa', endColorstr='#16d6ff', GradientType=1);
          /* IE6-9 */
          .iconay {
            color: #fff;
          }
