              ...
              <div class="preLogin-account-item">
                <div class="row">
                  <div class="input-field col s12 account-input-field">
                    <input type="text" v-model="loginData.account" class="ng-pristine ng-valid ng-empty ng-touched input"
                      placeholder="用户名(6-10位数字和字母)" tabindex="10">
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s12">
                    <input type="password" v-model="loginData.password" class="ng-pristine ng-valid ng-empty ng-touched input"
                      placeholder="密   码(6-16位数字或字母）" tabindex="11">                   
                ...
                <div class="row">
                  <div class="input-field col s7">
                    <input type="text" v-model="loginData.imageCode" class="verifyCode ng-pristine ng-valid ng-empty ng-valid-maxlength ng-touched input"
                      maxlength="4" placeholder="验证码" tabindex="12">
                  </div>
                ...
                <div class="row">
                  <div class="input-field col s12 button-input-field">
                    <input type="submit" class="btn-submit" @click="login();" value="登录" tabindex="13">
                  </div>
                </div>
              </div>
            <!-- </form> -->
