    ...
    <el-container class="views">
      <el-aside class="side">
        <div class="menus">
          ...
          <div class="tree">
          <el-tree v-show="!hideMenu" :data="treeData" node-key="id" :expand-on-click-node="true" :icon-class="'=='"
            default-expanded-keys="pc" :highlight-current="true" @node-click="nodeClick"></el-tree>
          </div>
          <div class="btns">
            <el-button icon="el-icon-plus" type="primary" @click="handleCreate" style="width:145px;">添加页面</el-button>
          </div>
        </div>
      </el-aside>
      <el-main>
      ...
      <el-form ref="dataForm" :model="pagesTemp" label-position="right" label-width="90px">
        ...
        <el-form-item label="页面内容" prop="layout">
          <el-select v-model="pagesTemp.content" placeholder="请选择页面内容">
            <el-option :label="item.name" :value="item.shortId" v-for="(item,i) in contentList" :key="i"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="说明" prop="remarks">
          <el-input v-model="pagesTemp.remarks" type="textarea" :autosize="{ minRows: 3, maxRows: 10}" />
        </el-form-item>
        <hr>
        ...
        <el-form-item label="页面描述" prop="description">
          <el-input v-model="pagesTemp.description" :autosize="{ minRows: 3, maxRows: 10}" type="textarea" />
        </el-form-item>
        <hr>

        <el-form-item label="头部代码" prop="script">
          <el-input :autosize="{ minRows: 3, maxRows: 100}" type="textarea" v-model="pagesTemp.head" placeholder="代码将插入至<head>标签末尾" />
        </el-form-item>

        <el-form-item label="底部代码" prop="style">
          <el-input :autosize="{ minRows: 3, maxRows: 100}" type="textarea" v-model="pagesTemp.foot" placeholder="代码将插入至<body>标签末尾" />
        </el-form-item>
      </el-form>
