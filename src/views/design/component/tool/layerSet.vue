            ...
            <el-form :label-position="'left'" label-width="70px" :model="settingForm">
              <el-collapse v-model="activeNames">
                  ...
                  <el-form-item label="形状内容" prop="content" v-if="layerjson.type==9">
                    <div @click="$bus.$emit('openSvgList','ChangSvg')" class="img-view">
                      <svg
                        ...
                        width="100%"
                        height="100%"
                        :viewBox="settingForm.config.viewBox"
                        xml:space="preserve"
                        preserveAspectRatio="none"
                        v-show="settingForm.config.content"
                      >
                  ...
                  <el-form-item label="组件内容" prop="style" v-if="layerjson.type==10">
                    <el-button-group>
                      ...
                      <el-button
                        type="danger"
                        size="mini"
                        v-show="settingForm.config.categoryModel"
                        @click="showDataList"
                      >组件数据</el-button>
                    </el-button-group>
                  </el-form-item>
                ...
                <el-collapse-item
                  title="文本"
                  name="1"
                  v-show="layerjson.type!=2&&layerjson.type!=9&&layerjson.type!=10"
                >
