                      ...
                      <div class="line-style">
                        <el-tooltip class="item" effect="dark" content="加粗" placement="top">
                          <i
                            ...
                            @click="styleForm.text.fontWeight?styleForm.text.fontWeight='':styleForm.text.fontWeight='bold';$bus.$emit('saveHistory','更改文本粗体[hover]');$bus.$emit('renderStyle')"
                          ></i>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="倾斜" placement="top">
                          <i
                            ...
                            @click="styleForm.text.fontStyle?styleForm.text.fontStyle='':styleForm.text.fontStyle='italic';$bus.$emit('saveHistory','更改文本倾斜[hover]');$bus.$emit('renderStyle')"
                          ></i>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="下划线" placement="top">
                          <i
                            ...
                            @click="styleForm.text.textDecoration=='underline'?styleForm.text.textDecoration='':styleForm.text.textDecoration='underline';$bus.$emit('saveHistory','更改文本下划线[hover]');$bus.$emit('renderStyle')"
                          ></i>
                        </el-tooltip>
                        <el-tooltip
                          class="item"
                        ...
                        >
                          <i
                            ...
                            @click="styleForm.text.textDecoration=='line-through'?styleForm.text.textDecoration='':styleForm.text.textDecoration='line-through';$bus.$emit('saveHistory','更改文本删除线[hover]');$bus.$emit('renderStyle')"
                          ></i>
                        </el-tooltip>
                      </div>
                    </el-collapse-item>
                    <!-- 文本 -->
                    <el-collapse-item title="超文本" name="1" v-if="layerjson.type==3">
                      <Tinymce :height="100" v-model="config.content" v-if="layerjson.type==3"></Tinymce>
                      <el-form-item
                        label="行高"
                        prop="border"
