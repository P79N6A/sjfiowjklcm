<template>
    ...
    <div class="ishow-picToolMain">
        ...
        <div v-if="isOpen" style="line-height:1;">
            <el-dialog :title="title+'素材'" :visible.sync="dialogVisible" size="small-1000" :before-close="closeVideoLayer" width="900px">
                <list-layer :json-data="jsonData" ref="videoLayer" :is-bg="isBg" :type="type" :isLoading="isLoading"></list-layer>
            </el-dialog>

            <el-dialog :title="'预览'+title" :visible.sync="dialogVisible2" size="small-700" top="3%" width="900px">
