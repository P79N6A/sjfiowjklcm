<template>
    ...
    <div class="ishow-picToolMain">
        ...
        <div v-if="isOpen" style="line-height:1;">
            <el-dialog title="图片素材" :visible.sync="dialogVisible" size="small-1000" :before-close="closePicLayer" width="900px">
            ...
            <!-- 裁切弹层 -->
            <el-dialog :title="cropTitle" :visible.sync="dialogVisible3" top="3%" v-if="type!=='pic'" width="900px">
