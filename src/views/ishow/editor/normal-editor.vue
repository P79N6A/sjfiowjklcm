<template>
  <div class="normal-style">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-input
            ...
            v-model="content"
            @change="addHistroy"
            @focus="contentChange(true)"
            @blur="contentChange(false)"
          ></el-input>
        </div>
      </div>
    </div>
    <div class="form-group" v-if="ctype===2">
      ...
      <div class="mt10 tc">
        <el-button size="small" type="primary" @click="updateImg">
          <i class="fa fa-refresh mr10" aria-hidden="true"></i>修改图片
        </el-button>
    ...
    <div class="form-group">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-slider v-model="valueOpacity" show-input @change="addHistroy"></el-slider>
        </div>
      </div>
    </div>
    <div class="form-group" v-if="ctype!==7">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-slider v-model="valuePadding" :max="valuePaddingMax" show-input @change="addHistroy"></el-slider>
        </div>
      </div>
    </div>
    <div class="form-group" v-if="ctype===1">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-slider v-model="valueLineH" :max="valueLineHMAx" show-input @change="addHistroy"></el-slider>
        </div>
      </div>
    </div>
    <div class="form-group" v-if="ctype===1||ctype===6||ctype===7">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-slider v-model="fontSize" :max="fontSizeMAx" show-input @change="addHistroy"></el-slider>
        </div>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="clearfix">
        <div class="form-center w168">
          <el-slider v-model="rotate" :max="rotateMax" show-input @change="addHistroy"></el-slider>
        </div>
      </div>
    </div>
    <div class="form-group" v-if="ctype===1">
