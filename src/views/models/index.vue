<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="modelList" border fit highlight-current-row style="width: 100%;">
    ...
    <!-- 编辑弹窗 -->
    <el-dialog :title="`数据模型--${textMap[dialogStatus]}`" :visible.sync="dialogFormVisible" width="700px">
      <el-form ref="dataForm" :model="modelTemp" label-position="right" label-width="80px">
            ...
            <table class="model-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>内容缩略图</td>
                  <td>
                    <el-switch v-model="modelTemp.system.thumbnail" active-color="#13ce66" inactive-color="#ff4949">
                    </el-switch>
                  </td>
                </tr>
                <tr v-if="modelTemp.system.thumbnail">
                  <td colspan="4">
                    <el-input placeholder="请输入缩略图宽度" v-model="modelTemp.mixed.thumbnailSize.width" class="input-with-select">
                ...
                <tr v-if="modelTemp.system.thumbnail">
                  <td colspan="4">
                    <el-input placeholder="请输入缩略图高度" v-model="modelTemp.mixed.thumbnailSize.height" class="input-with-select">
                ...
                <tr>
                  ...
                  <td>内容摘要</td>
                  <td>
                    <el-switch v-model="modelTemp.system.abstract" active-color="#13ce66" inactive-color="#ff4949">
                    </el-switch>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>内容</td>
                  <td>
                    <el-switch v-model="modelTemp.system.content" active-color="#13ce66" inactive-color="#ff4949">
                    </el-switch>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>内容标签</td>
                  <td>
                    <el-switch v-model="modelTemp.system.tags" active-color="#13ce66" inactive-color="#ff4949">
                    </el-switch>
                  </td>
                </tr>
              </tbody>
        ...
        <el-card shadow="hover">
          ...
          <div class="items">
            <el-table :data="modelTemp.extensions" border fit highlight-current-row style="width: 100%;">
              ...
              <el-table-column label="操作" align="center" width="150">
                <template slot-scope="scope">
                  <el-button-group>
                    <el-button type="primary" @click="editKey(scope.row,scope.$index)" size="mini">编辑</el-button>
          ...
          <div class="bottom clearfix">
            <el-button type="primary" block style="width:100%;" icon="el-icon-plus" @click='handleCreateKey'>新增键</el-button>
          </div>
        </el-card>
      </el-form>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?createModel():updateModel(modelTemp)">{{ $t('table.confirm') }}</el-button>
      </div>
    </el-dialog>
    <!-- 添加扩展键 -->
    <el-dialog :title="`扩展键--${textMap[dialogStatus]}`" :visible.sync="dialogExtendVisible" width="500px">
      <el-form ref="dataFormKey" :model="keyTemp" label-position="right" label-width="50px">
        ...
        <el-form-item label="*类型" prop="type">
          <el-select v-model="keyTemp.type" placeholder="请选择">
            <el-option v-for="item in keyType" :key="item.value" :label="item.name" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <!-- 媒体数量设定 -->
        ...
        <el-form-item label="数量" v-if="keyTemp.type=='select'||keyTemp.type=='checkbox'">
          <el-table v-loading="listLoading" :data="keyTemp.mixed.select" border fit highlight-current-row style="width: 100%;">
            <el-table-column :label="$t('table.id')" type="index" align="center" width="50"></el-table-column>
            <el-table-column label="名称" prop="name" align="center"></el-table-column>
            <el-table-column label="值" prop="value" align="center"></el-table-column>
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button type="primary" icon="el-icon-delete" @click="deleteKeySelect(scope.$index)">移除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-form :model="selectTemp" label-position="right" label-width="50px" class="selectTempForm">
            <el-form-item label="名称" prop="name">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?createKey():updateKey()">{{ $t('table.confirm') }}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 创建模型
      createModel() {
        addModels(this.modelTemp).then(res => {
