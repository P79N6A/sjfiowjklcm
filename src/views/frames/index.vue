      ...
      <el-tabs type="border-card" v-model="frameType">
        <el-tab-pane label="整站框架" name="layout">
              ...
              <div class="frames">
                <div class="frames-content">
                  <div class="control">
                    <!-- 操作按钮区域 -->
                    <el-button-group>
                      <el-button type="primary" round icon="el-icon-edit" @click="editFrame(item,'layout')">编辑</el-button>
                  ...
                  <div class="show" v-for="(block,i) in item.value" :key="i">
                    ...
                    <div v-else>
                      <el-row v-for="(row,r) in block.rows" :key="i+'-'+r" class="rows" :style="{width:row.fullWidth?'100%':'90%',margin:'0 auto'}">
                        <!-- 行区域 -->
          ...
          <div class="bottom cfx">
            <el-button icon="el-icon-plus" type="primary" @click="addFrame('layout')">添加框架</el-button>
          </div>
        </el-tab-pane>
