    ...
    <el-table v-loading="listLoading" :data="imgList" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column fixed align="center" label="封面" prop="thumbnail" width="80">
        <template slot-scope="scope">
          <a target="_blank" :href="`${scope.row.icon}`" class="img-view" :style="`background-image:url('${scope.row.icon}');`"></a>
        </template>
      </el-table-column>
              ...
              <tr>
                <td>
                  <el-form-item label="封面" prop="thumbnail">
                    <el-upload class="avatar-uploader" action="/api/imgs/icon" :show-file-list="true" :on-success="handleAvatarSuccess"
                      :before-upload="beforeAvatarUpload" :data="imgTemp" :auto-upload="true" list-type="text" ref="gameIcon"
                      :limit="1" :on-change="handleChange" :on-remove="handleRemove">
                      <a v-if="imgTemp.icon" class="img-view" style="width:120px;height:120px;display:block;" :style="`background-image:url(${imgTemp.icon});`">
                ...
                <td>
                  <el-form-item label="在线状态" prop="online">
                    <el-switch v-model="imgTemp.online" active-color="#13ce66" inactive-color="#ff4949" active-text="是"
