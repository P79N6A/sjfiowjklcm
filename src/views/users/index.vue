<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column :label="$t('table.id')" type="index" align="center" width="65"></el-table-column>
      <el-table-column label="用户昵称" width="100px" align="center" prop="nickname"></el-table-column>
      <el-table-column label="邮箱地址" min-width="150px" prop="email"></el-table-column>
      <el-table-column label="用户类型" prop="type"></el-table-column>
      <el-table-column label="权限分组" min-width="150px" prop="role.name">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="500px">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="dialogStatus==='create'?createUsers():updateUsers()"
...
export default {
  ...
  methods: {
    ...
    //       this.userTemp.author = 'vue-element- m'
