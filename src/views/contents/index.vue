  ...
  <div class="content-container">
    ...
    >
      ...
      <el-table-column :label="extend.name" v-for="(extend,i) in modelTemp.extensions" :key="i">
        <template slot-scope="scope">
          <div v-if="extend.type=='media'"></div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="900px">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?addContents():updateCategories()">
          {{ $t('table.confirm')
          }}
        </el-button>
      </div>
    </el-dialog>
    <el-dialog title="内容预览" :visible.sync="dialogViewVisible" width="1300px">
      <el-tabs type="border-card" v-model="tabActive">
        <el-tab-pane name="device_pc">
          <span slot="label">
            <i class="el-icon-date"></i> 电脑预览
          </span>
          <div class="mac">
