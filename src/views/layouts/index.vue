  ...
  <div class="layouts-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="800px">
      <el-form ref="dataFormKey" :model="layoutTemp" label-position="right" label-width="80px">
        ...
        <el-form-item label="*布局终端" prop="name">
        ...
        <el-form-item label="*选择框架" prop="name">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="dialogStatus==='create'?createLayout():updateLayout()"
  ...
  export default {
    ...
    methods: {
      ...
      this.$confirm("此操作将永久删除该数据, 是否继续?", "提示", {
        ...
        .then(() => {
          deleteLayouts({ _id: row._id }).then(res => {
            this.getLayouts();
            this.$notify({
              title: "成功",
              message: "操作成功",
