      ...
      <el-row :gutter="20">
        ...
        <el-col :span="10">
          <el-button-group>
            ...
            <el-button @click="dialogStyleVisible=true">高级样式</el-button>
            <el-button @click="editFrame=!editFrame">编辑布局</el-button>
            <el-button @click="updateLayouts">保存</el-button>
            <el-button @click="viewLayoutsClass?viewLayoutsClass='':viewLayoutsClass='layoutEdit'">
              <span v-if="viewLayoutsClass">预览</span>
              <span v-else>编辑</span>
            </el-button>
          ...
          <div v-if="block.isPageView">
            <el-button-group class="block-controls" v-show="viewLayoutsClass">
              ...
              <el-tooltip
                ...
                content="向下移动"
                placement="top-start"
                v-if="i!=layoutTemp.value.length-1"
              >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div
                    v-show="viewLayoutsClass"
                    style="padding:4px;position:absolute;left:10px;bottom:10px;z-index:99;"
                  >
