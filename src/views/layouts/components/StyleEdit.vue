<template>
  <div class="editStyle" v-if="value">
    <el-button-group>
      ...
      <el-button icon="el-icon-check" type="danger">保存({{EditType}})</el-button>
    </el-button-group>
            ...
            <el-form ref="form" label-width="80px">
              ...
              <el-form-item label="重复模式">
                <el-select v-model="style.backgroundRepeat" placeholder="请选择">
                  <el-option v-for="item in BgRepeatOption" :key="item.value" :label="item.name" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="背景大小">
                <el-select v-model="style.backgroundSize" placeholder="请选择">
                  <el-option v-for="item in BgSizeOption" :key="item.value" :label="item.name" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="背景位置">
                <el-select v-model="style.backgroundPosition" placeholder="请选择">
                  <el-option v-for="item in BgPositionOption" :key="item.value" :label="item.name" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
            </el-form>
          </el-collapse-item>
            ...
            <el-form ref="form" label-width="80px">
              ...
              <el-form-item label="边框类型">
                <el-select v-model="style.borderStyle" placeholder="请选择">
                  <el-option v-for="item in BorderStyleOption" :key="item.value" :label="item.name" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
            </el-form>
          </el-collapse-item>
            ...
            <el-form ref="form" label-width="80px">
              <el-form-item label="定位方式">
                <el-select v-model="style.PositionOption" placeholder="请选择">
                  <el-option v-for="item in PositionOption" :key="item.value" :label="item.name" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
