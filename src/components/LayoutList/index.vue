    ...
    >
      <el-row>
        ...
        <el-col :span="20">
          <div class="img-list">
            <!-- <div></div> -->
            <div class="search" v-show="filterData.type=='view'">
              归类：
              <span
                @click="filterData.class='text'"
                :class="{active:filterData.class=='text'}"
              >文本模板</span>
              <span @click="filterData.class='img'" :class="{active:filterData.class=='img'}">图片模板</span>
              <span
                @click="filterData.class='imgtext'"
                :class="{active:filterData.class=='imgtext'}"
              >图文模板</span>
            </div>
            <div class="search" v-show="filterData.type=='func'">
              归类：
              <span
                @click="filterData.class='user'"
                :class="{active:filterData.class=='user'}"
              >用户</span>
              <span @click="filterData.class='money'" :class="{active:filterData.class=='money'}">金流</span>
              <span @click="filterData.class='promo'" :class="{active:filterData.class=='promo'}">优惠</span>
              <span @click="filterData.class='log'" :class="{active:filterData.class=='log'}">记录</span>
              <span @click="filterData.class='sale'" :class="{active:filterData.class=='sale'}">营销</span>
              <span @click="filterData.class='other'" :class="{active:filterData.class=='other'}">其他</span>
            </div>
            <div class="img-box">
...
import { getLayouts, buyLayouts } from "@/api/layouts";
...
export default {
  ...
  created() {
    this.$bus.$on("openLayoutList", emitEvent => {
