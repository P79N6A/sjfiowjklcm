<template>
  <div class="img-container">
      ...
      <el-row>
        ...
        <el-col :span="20">
          <div class="img-list">
            ...
            <div class="img-box">
              <div class="img-content" v-for="(item,i) in demoList" :key="i">
                <div class="img-view" :style="`background-image:url('${item.src}')`"></div>
                <div class="img-control">
                  <el-button @click="select(item)">使用</el-button>
                  <div class="icons">
                    <i class="el-icon-star-off"></i>
                    <i class="el-icon-view" @click="preList=demoList;preIndex=i;showPre=true;"></i>
                  </div>
                </div>
    ...
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <div style="padding:20px;line-height:1.5;">本平台图片版权许可与服务协议
        <h3>第一条 图片版权声明</h3>本平台平台图片库中所有收费图片素材均是经版权方合法授权的正版素材，其知识产权和所有权归版权方所有。用户须购买后方可享有有限使用权。
        <h3>第二条 授权使用方式</h3>本平台提供的图片授权是免版税金（RF, Royalty-Free）使用图片版权的方式。用户购买图片使用授权后，图片的使用权是非排他性的、全球性的、单用户的使用权，不受使用次数的限制，使用权不可转让。
...
export default {
  ...
  data() {
    return {
      ...
      demoList: [
        {
          src:
            "http://res1.eqh5.com/store/e64edc6153488a6e5ecb20e22b80b1c1.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 6
        },
        {
          src:
            "http://res1.eqh5.com/store/876fefcd574fabf7dd2a76109101f7cc.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 3
        },
        {
          src:
            "http://res1.eqh5.com/store/05c01ea80b89ca92d2244f5a2fc1f906.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 2
        },
        {
          src:
            "http://res1.eqh5.com/store/c30f44a277c4f9df66caef88461db484.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 2
        },
        {
          src:
            "http://res1.eqh5.com/store/df3bf2a8fa99d58a4be67fe0afee2621.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 5
        },
        {
          src:
            "http://res1.eqh5.com/store/f6c7c8bc4712771e07975720e2267495.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 3
        },
        {
          src:
            "http://res1.eqh5.com/store/a1fdc825284ad251a468e8f156a6d8f4.gif?imageMogr2/auto-orient/thumbnail/136x136%3E",
          price: 6
        }
      ],
      showPre: false,
  ...
  methods: {
    ...
    select(item) {
      console.log(item);
      this.$bus.$emit(this.emitEvent, item.src);
    }
  }
};
</script>
